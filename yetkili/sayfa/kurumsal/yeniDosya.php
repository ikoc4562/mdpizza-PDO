...
$kac = mysql_query("SELECT * FROM kurumsaldosya");
...
$sql = mysql_query("INSERT INTO kurumsaldosya (baslik,kat,baslik_eng,fotograf,aktif,sira) VALUES ('".$baslik."','".$_POST['kat']."','".$baslik_eng."','".$resim."','1','".$sonsayi."')");
$mesaj = 'başarılı';
