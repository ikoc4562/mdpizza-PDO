...
mysql_query("UPDATE egitmenler SET adsoyad='".$adsoyad."',aktif='".$_POST['aktif']."',email='".$email."',telefon='".$telefon."',facebook='".$facebook."',instagram='".$instagram."',tarih='".$tarih."',il='".$il."',hakkinda='".$icerik."' WHERE id = ".$_GET['id']."");
...
$ssql = mysql_query("SELECT * FROM egitmenler WHERE id = '".$_GET['id']."'");
